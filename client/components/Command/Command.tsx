...
>(({ className, ...props }, ref) => (
  <CommandPrimitive ref={ref} className={styles.command} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <div className={styles.commmandInputWrapper} cmdk-input-wrapper="">
...
const CommandShortcut = ({
  ...
  return <span className={styles.commandShortcut} {...props} />;
};
